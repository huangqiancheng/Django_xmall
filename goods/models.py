...
class Good(models.Model):
    salePrice = models.DecimalField(verbose_name="零售价",max_digits=10,decimal_places =2,default =0)
...
class Goodimage(models.Model):
    image = models.ImageField(verbose_name="商品图片",upload_to="product/detail/")
    good_id = models.ForeignKey('Good',verbose_name="商品名",on_delete=models.CASCADE,related_name="good")
    created = models.DateTimeField(auto_now_add=True, verbose_name="创建时间")
    updated = models.DateTimeField(auto_now=True, verbose_name="更新时间")
