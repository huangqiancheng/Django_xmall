...
class Address(models.Model):
    name = models.CharField(max_length=20,verbose_name ="名称",null=True,blank=True)
    ...
    user_id = models.ForeignKey(User,on_delete=models.CASCADE,related_name="user_id",verbose_name ="姓名")
